...
- Per-band bypass, band-pass solo audition, Stereo/Left/Right/Mid/Side, Adaptive Q,
...
- The first ten displayed `default_distortion` drive algorithms, spectrally
  isolated per band; Drive/Character/Secondary/Tone/Mix/Comp/bypass and DC blocking.
...
- Regular parameter-derived and Smart 500 ms measured Auto Gain with progress,
  schema-v5 single-state recall and v3 migration, no published A/B/link-group
